...
export default class edit_ofers extends Component {
    constructor(props) {
        super(props);
    ...
    handlePost(event) {
        ...
        fetch('http://localhost:5000/api/ofers/' + state.lId,{
            method:'PUT',
            headers:{
        ...
        return (
            ...
            <Form onSubmit={this.handlePost}>
                ...
                <Form.Group controlId="Category">
                    ...
                    <Form.Control as="textarea" type="text" name="Category" required defaultValue={state.lCategory}></Form.Control>
                </Form.Group>
